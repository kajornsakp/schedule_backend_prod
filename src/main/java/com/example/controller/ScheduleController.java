...
public class ScheduleController {
	...
	@RequestMapping(value = "/editSubject", method = RequestMethod.PUT, produces = {MediaType.APPLICATION_JSON_VALUE},consumes = "application/json")
	public void editSubject(Subject s) {
		DataHandler.editSubject(s);
	}
